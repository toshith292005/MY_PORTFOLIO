...
// Portfolio data for projects carousel

const portfolioData = [
    {
        id: 1,
        title: 'Smart Hydration Bottle',
        description: 'An IoT-based smart bottle designed to monitor daily water intake and encourage healthy hydration habits.',
        image: 'images/project1.jpg',
        tech: ['IoT', 'Sensors', 'Microcontroller', 'Embedded Systems']
    },
    {
        id: 2,
        title: 'GearUp – Travel Companion App',
        description: 'A comprehensive travel companion application for long-distance riders offering route planning.',
        image: 'images/project2.jpg',
        tech: ['HTML', 'CSS', 'JavaScript', 'APIs', 'System Design']
    },
    {
        id: 3,
        title: 'API Automation Framework',
        description: 'A REST API automation framework built to validate endpoints, response codes, and data integrity.',
        image: 'images/project3.jpg',
        tech: ['REST APIs', 'Postman', 'JSON', 'Automation Testing']
    },
    {
        id: 4,
        title: 'Smart Irrigation System',
        description: 'An IoT-based irrigation system that automates water supply based on soil moisture levels.',
        image: 'images/project4.jpg',
        tech: ['IoT', 'Arduino', 'Sensors', 'Embedded Systems']
    },
    {
        id: 5,
        title: 'Expense Tracker Application',
        description: 'A personal finance web application that helps users track income, expenses, and spending patterns.',
